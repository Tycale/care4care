...
Thus ends our last report. This project has taught us many things. First of all, the amount of functionnalities in the specifications was huge and we didn’t know how to start the project. The first two phases learned us to read specifications and modelize it. We also learned some usefull tools, like the django framework, who helped us to give live to our project quickly. We used github to synchronise the code source of the project, this tool was new for some of us but was quickly adopted. Without github, it would be hard to consider working all together at the same time in the project. The challenge of being eight in the group was overcome with Trello. This organization tool helped us to dispatch the work between us. We have to admit that the begining of the project was difficult because we were not very well organised. This poor start made us lose time that we caught at the end.

This project was very rewarding, firstly because we were in real developement conditions with real expectations from a client and secondly because we are really proud of the final result. 
