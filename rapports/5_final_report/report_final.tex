...
Everybody(except superuser witch is in all branch) can join a branch in the left menu to the section branch -> "Join branch"

\paragraph{Create a branch}
Superuser and verified member can create a branch using the left menu to the section branch -> "create a new branch". You have to specify a name for the branch and a location.
