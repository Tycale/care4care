(function() {
  $(function() {
    var GREEN_RGB, LIGHT_BLUE_RGB, ORANGE_RGB, account_types, account_types_chart, c_line, c_polar, c_radar, chart_job_categories, chart_user_status, data, data_account_types, data_job_categories, data_users_status, get2dContext, get_rgba, global_registration, global_users_chart, job_categories, line_chart, polar_chart, polar_data, radar_chart, users_registration, users_status_canvas;
    data = {
    ...
    return chart_job_categories = new Chart(job_categories).Radar(data_job_categories);
  });
