...
from main.views import statistics, \
                        ...
                        get_job_categories_json_view, get_branch_reg_users_json_view, \
                        get_users_status_json_view, get_user_job_categories_json_view, \
                        get_user_job_avg_time_json_view, get_user_jobs_amount_json_view, \
                        get_user_time_amount_json_view, get_user_km_amount_json_view, \
...
urlpatterns = patterns(
    ...
    url(r'^registrated_users_json/(?P<branch_id>\d+)/$', get_registrated_users_json_branch_view, name='branch_stats_reg_users_json'),
    url(r'^job_categories_json/(?P<branch_id>\d+)/$', get_job_categories_json_branch_view, name='branch_stats_job_categories_json'),
