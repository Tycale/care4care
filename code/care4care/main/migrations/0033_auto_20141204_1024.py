...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='contact',
            name='mobile_number',
            field=models.CharField(blank=True, max_length=16, verbose_name='Numéro de téléphone (mobile)', validators=[django.core.validators.RegexValidator(regex='^\\+?1?\\d{9,15}$', message="Votre numéro de téléphone doit être au format '+999999999'. Jusqu'à 15 chiffres.")]),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='contact',
            name='phone_number',
            field=models.CharField(blank=True, max_length=16, verbose_name='Numéro de téléphone (fixe)', validators=[django.core.validators.RegexValidator(regex='^\\+?1?\\d{9,15}$', message="Votre numéro de téléphone doit être au format '+999999999'. Jusqu'à 15 chiffres.")]),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='contact',
        ...
        migrations.AlterField(
            model_name='emergencycontact',
            name='order',
            field=models.IntegerField(default=0, verbose_name='Ordre de priorité', choices=[(1, 'A contacter en premier'), (2, 'A contacter'), (3, 'A contacter en dernier')]),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='emergencycontact',
        ...
        migrations.AlterField(
            model_name='user',
            name='user_type',
            field=models.IntegerField(default=1, choices=[(1, 'Membre'), (2, 'Non-membre'), (3, 'Membre vérifié')], verbose_name='Type de compte', help_text="Un member pourra aider ou être aidé alors qu'un                                         non-membre est un professionnel qui s'inscrira pour avoir accès aux données d'un                                         patient. Veuillez choisir celui qui vous correspond"),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='user',
            name='username',
            field=models.CharField(unique=True, max_length=30, verbose_name="Nom d'utilisateur", validators=[django.core.validators.RegexValidator(re.compile('^[\\w.@+-]+$', 32), "Entrez un nom d'utilisateur valide.             30 caractères ou moins. Peut contenir des lettres, nombres et les caractères @/./+/-/_ ", 'invalid')]),
            preserve_default=True,
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(default=1, verbose_name='Recevoir mes messages par', choices=[(1, 'Boite à message'), (2, 'Mail')]),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='verifieduser',
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(default=5, verbose_name='Recevoir des demandes et des offres de', choices=[(5, 'Tous'), (3, 'Membre vérifié'), (6, 'Mes membres favoris')]),
            preserve_default=True,
        ),
    ]
