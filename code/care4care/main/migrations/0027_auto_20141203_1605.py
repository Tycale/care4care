...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='contact',
            name='mobile_number',
            field=models.CharField(verbose_name='Numéro de téléphone (mobile)', max_length=16, blank=True, validators=[django.core.validators.RegexValidator(message="Votre numéro de téléphone doit être au format '+999999999'. Jusqu'à 15 chiffres.", regex='^\\+?1?\\d{9,15}$')]),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='contact',
            name='phone_number',
            field=models.CharField(verbose_name='Numéro de téléphone (fixe)', max_length=16, blank=True, validators=[django.core.validators.RegexValidator(message="Votre numéro de téléphone doit être au format '+999999999'. Jusqu'à 15 chiffres.", regex='^\\+?1?\\d{9,15}$')]),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='contact',
        ...
        migrations.AlterField(
            model_name='user',
            name='user_type',
            field=models.IntegerField(verbose_name='Type de compte', help_text="Un member pourra aider ou être aidé alors qu'un                                         non-membre est un professionnel qui s'inscrira pour avoir accès aux données d'un                                         patient. Veuillez choisir celui qui vous correspond", default=1, choices=[(1, 'Membre'), (2, 'Non-membre'), (3, 'Membre vérifié')]),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='user',
        ...
        migrations.AlterField(
            model_name='verifieduser',
            name='drive_license',
            field=multiselectfield.db.fields.MultiSelectField(verbose_name='Type de permis de conduire', max_length=11, blank=True, choices=[(1, 'Vélomoteur'), (2, 'Moto'), (3, 'Voiture'), (4, 'Camion'), (5, 'Bus'), (6, 'Tracteur')]),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='verifieduser',
