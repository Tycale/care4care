...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='branch',
            name='members',
            field=models.ManyToManyField(blank=True, related_name='members', to=settings.AUTH_USER_MODEL, verbose_name='Membres de la branche', null=True, through='branch.BranchMembers'),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='branch',
        ...
        migrations.AlterField(
            model_name='demand',
            name='donor',
            field=models.ForeignKey(blank=True, related_name='demand_donor', verbose_name='Donneur', to=settings.AUTH_USER_MODEL, null=True),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='demand',
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(default=5, verbose_name='Qui peut voir et répondre à la demande/offre ?', choices=[(5, 'Tous'), (3, 'Membre vérifié'), (6, 'Mes membres favoris')]),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='demand',
            name='receiver',
            field=models.ForeignKey(blank=True, related_name='demand_receiver', verbose_name='Receveur', to=settings.AUTH_USER_MODEL, null=True),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='demand',
        ...
        migrations.AlterField(
            model_name='offer',
            name='donor',
            field=models.ForeignKey(blank=True, related_name='offer_donor', verbose_name='Donneur', to=settings.AUTH_USER_MODEL, null=True),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='offer',
        ...
        migrations.AlterField(
            model_name='offer',
            name='receiver',
            field=models.ForeignKey(blank=True, related_name='offer_receiver', verbose_name='Receveur', to=settings.AUTH_USER_MODEL, null=True),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='offer',
