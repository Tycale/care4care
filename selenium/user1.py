...
class User(unittest.TestCase):
    ...
    def test_user(self):
        ...
        driver.find_element_by_id("username").send_keys("DGenon")
        ...
        driver.find_element_by_xpath("(//a[contains(text(),'Bruxelles')])[2]").click()
        ...
        driver.find_element_by_css_selector("#ignored > div.row.mt > div.col-lg-12.col-sm-12 > div.panel.panel-default > div.panel-body > div.row.mt > form > div.col-lg-9 > div.form-group > #id_user").send_keys("BLacasse")
        ...
        driver.find_element_by_id("id_user").send_keys("APaulus")
